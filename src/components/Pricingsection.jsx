...
const Pricingsection = () => {
    ...
    return (
        <div className="bg-white p-4 sm:p-8">
            ...
            <h2 className="text-2xl sm:text-4xl font-bold text-center mb-6">Find the best plan for your needs</h2>
           
            <div className="flex flex-col sm:flex-row justify-center items-center mb-8 space-y-4 sm:space-y-0 sm:space-x-4">  <button
                onClick={() => setIsAnnual(false)}
                className={`w-1/2 sm:w-auto px-4 py-2 font-semibold rounded-lg transition-colors duration-300 ${!isAnnual ? 'text-white bg-black' : 'text-black bg-gray-200'}`}
            >
                Monthly
            </button>
                <button
